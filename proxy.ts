...
const CSRF_EXEMPT_PREFIXES = ['/api/webhooks/', '/api/workers/', '/api/cron/', '/api/portal/', '/api/marketing/send', '/api/marketing/bounce-poll', '/api/marketing/reply-poll', '/api/marketing/track/', '/api/marketing/unsubscribe', '/api/admin/dispatch-goalfest']
...
export async function proxy(request: NextRequest) {
  ...
  const isPublic =
    ...
    pathname.startsWith('/api/admin/dispatch-goalfest')
