  ...
  return (
    <div className="min-h-screen bg-white overflow-x-clip">
      ...
      >
        ...
        />
        <div className="relative max-w-6xl mx-auto px-6 md:px-12 py-10 md:py-14">
          <Image src="/logo-branco.png" alt="Quic" width={110} height={44} priority className="mb-7" />
          ...
          <button
            ...
            className="mt-8 flex items-center gap-3 px-4 py-2.5 text-xs font-semibold tracking-[0.2em] uppercase text-white bg-[var(--quic-magenta)] rounded-full hover:bg-[var(--quic-magenta-hover)] transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
          >
            Descobrir
