...
export const metadata: Metadata = {
  title: 'Privacidade — Jogo de Portugal · QUiC',
  description: 'Política de privacidade e tratamento de dados RGPD para o registo do jogo de Portugal.',
}

const SUBPROCESSORS: { name: string; role: string }[] = [
  { name: 'Supabase', role: 'base de dados · alojada na União Europeia' },
  { name: 'Brevo', role: 'envio do SMS aos vencedores' },
...
const SECTIONS: { num: string; label: string; body: React.ReactNode }[] = [
  ...
  },
  {
    ...
    body: (
      <p>
        Os dados servem para participar no sorteio da cerveja durante o jogo de
        Portugal e, se ganhares, enviar-te o SMS com o código QR. Podemos ainda
        contactar-te para divulgar futuros projetos e eventos da QUiC. Nunca
        vendemos nem partilhamos os teus dados com terceiros para fins de
        marketing externo.
      </p>
    ),
  },
