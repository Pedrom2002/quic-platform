          ...
          <div className="mb-16 sm:mb-20 md:mb-24">
            ...
            <ul>
              {completedItems.map((item, idx) => (
                <li
                  key={item.id}
                  className="flex flex-col sm:grid sm:grid-cols-[2rem_1fr_auto] gap-2 sm:gap-6 md:gap-10 py-5 sm:py-6 px-4 -mx-4 rounded-lg bg-emerald-100 border border-emerald-300 last:border-0 mb-2"
                >
