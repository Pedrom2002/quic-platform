              ...
              return (
                ...
                >
                  ...
                  <div className="grid grid-cols-[64px_1fr_auto] items-start gap-6 py-8 pl-6">
                    {/* ghost number */}
                    <span className="text-5xl sm:text-6xl font-bold leading-none select-none block text-right" style={{ fontFamily: 'var(--font-playfair), Georgia, serif', color: isNew ? 'rgba(255,255,255,0.55)' : 'rgba(255,255,255,0.22)' }}>
