        ...
        <Card className="border-zinc-800 bg-zinc-900">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              Regista o teu pedido de acesso à área de investidor
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-sm text-zinc-500">
                Já tens conta? <Link href="/investors/login" className="text-[var(--quic-magenta)] hover:underline">Entrar</Link>
              </p>
            </form>
          </CardContent>
        </Card>
