...
const styles = StyleSheet.create({
  ...
  tabButtonText: { fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.5, color: colors.gray500, fontWeight: '600', textAlign: 'center' },
  tabButtonTextActive: { color: QUIC_MAGENTA },
  body: { padding: 16 },
  tabContent: { gap: 12 },
  pastToggle: { paddingVertical: 8 },
  pastTogglePressed: { opacity: 0.6 },
  pastToggleText: { fontSize: 12, color: colors.gray500, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1 },
  card: { backgroundColor: colors.gray50, borderWidth: 1, borderColor: colors.gray100, borderRadius: 6, padding: 14 },
  cardMeta: { fontSize: 11, color: colors.gray500, marginBottom: 4 },
